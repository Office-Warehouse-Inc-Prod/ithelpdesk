...
.owi-navbar .dropdown-menu {
  ...
  margin-top: 10px;
    ...
    <select name="sla_days" id="sla_days" class="form-control form-control-sm custom-select-placeholder placeholder-active" required onchange="handleDropdownChange(this)">
      ...
      <div class="form-group col-md-12">
      <p>
      <button class="btn btn-primary float-right mr-2" type="button" name="msgbtn" id="msgbtn" value="show" data-toggle="collapse" data-target="#msg_thread" aria-expanded="false" aria-controls="msg_thread">
      Show Message Thread
      </button>
      </p>
      </div>
