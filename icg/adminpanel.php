...
<div id="welcomeModal" class="modal-overlay" style="display: none; ">
    <div class="modal-content">
        <h3>Inventory Control Group HelpDesk Efficiency & Performance Report</h3>
        ...
        <main class="p-4">
          <div class="row g-4">
            ...
            <div class="row" id="ovrall">
              ...
              <div class="col-12 col-lg-6 mb-3">
                <div class="card card2 h-100">
                  <h5 class="card-header text-black" style="background: linear-gradient(135deg, #213456, #334c7a); color:black;">ICG Support Logs
                  </h5>
                  <div class="card-body">
