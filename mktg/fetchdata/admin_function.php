...
class dbconfig extends dbconn
{
	...
	public function overallpie_res(){
		...
		$query="
			...
			where `reports`.`sub_id` NOT IN ('15','28','34','35') AND `status` NOT IN ('WAITING FOR IT HELPDESK RESPONSE','NEW REPORT','ASSIGNED') AND YEAR(date_created) IN (".$_POST['yr'] .") AND reports.f_deptsel = '3'
			GROUP BY `status`
	...
	public function admin_data_table_transfer()
{
    ...
    WHERE vw_transfer.deptsel = '3' 
    AND vw_transfer.f_deptsel NOT IN ('3') 
