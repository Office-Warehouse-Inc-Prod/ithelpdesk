  ...
  <form method="post" id="newrpt_form" enctype="multipart/form-data">
   <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group col-md-4">
        <label>SUBJECT</label>
        <textarea name="concern" id="concern" class="form-control form-control-sm custom-disabled-input" placeholder="Input Concern" style="text-transform:uppercase" onkeyup="this.value = this.value;" readonly></textarea>
      </div>
      ...
      <div class="form-group col-md-12">
        <label>CONCERN</label>
        <textarea name="concern" id="message" class="form-control form-control-sm custom-disabled-input" placeholder="Input Concern" 
      ...
      <div class="form-group col-md-8">
        ...
        <option value=""style="color:red;"> &larr; ASSIGN SUPPORT &rarr;</option>
          <?php
            $query="select * from it_tech WHERE itsup NOT IN ('4','7','8','12','14') AND deptsel = '3'";
            $run=$con1->prepare($query);
            $run->execute();
            $rs=$run->get_result();
            while ($res=$rs->fetch_assoc()) {
      ...
      <div class="form-group col-md-6">
        ...
        <?php
          $query="select * from categories WHERE deptsel = '3' AND (old_tag IS NULL OR old_tag <> 'Y') ORDER BY order_id ASC";
          $run=$con1->prepare($query);
          $run->execute();
          $rs=$run->get_result();
          while ($res=$rs->fetch_assoc()) {
      ...
      <div class="form-group col-md-4 hide_isp">
        ...
        <select class="form-control form-control-sm custom-select-placeholder placeholder-active" name="isp" id="isp"required onchange="handleDropdownChange(this)">
      ...
      <div class="form-group col-md-4 hide_isp" >
        ...
        <input type="text" class="form-control form-control-sm custom-select-placeholder placeholder-active" name="refNo" id="refNo">
      </div>
