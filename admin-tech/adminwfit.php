...
.notif-badge {
  ...
  border-radius: 50rem;
  border: 2px solid #fff; /* Cuts the badge cleanly away from the bell icon */
...
.modern-notif-dropdown {
  ...
  max-width: 90vw;
  padding: 0;
  border-radius: 12px !important; /* Smooth curved card edges */
  margin-top: 10px;
  overflow: hidden;
  box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08) !important;
}

/* Smooth Scrollbar Containment */
.notif-scroll-area {
  max-height: 400px;
  overflow-y: auto;
}
...
/* Clean Dynamic Table Formatting */
.style-clean-table {
...
/* Individual Cell Adjustments (Use these classes inside your JS layout logic) */
.notif-cell {
  padding: 12px 16px !important;
  display: block;
}
.notif-cell.unread {
  background-color: #f0f9ff; /* Subtle blue tint for unread items */
}
.notif-cell.unread:hover {
  background-color: #e0f2fe;
}

/* Content & Date Layout text specs */
.notif-text {
  font-size: 0.875rem;
  color: #334155;
  line-height: 1.4;
  white-space: normal; /* Permits text wrapping inside lines */
}
.notif-date {
  font-size: 0.75rem;
  display: block;
