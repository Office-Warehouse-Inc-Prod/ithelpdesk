...
<head>
    ...
    <style>
        ...
        /* Table Styles */
        #new_rep_table { width:100% !important; background-color: #ffffff; border-collapse: separate; border-spacing: 0; border-radius: 8px; overflow: hidden; box-shadow: 0 10px 8px rgba(108, 108, 53, 0.4); border: 1px solid #e9ecef; }
        ...
        /* Input Alignments and Design */
        label { font-size: 11px; font-weight: 900; color: #213456; letter-spacing: .08em; text-transform: uppercase; margin-bottom: 6px; display: block; }
        .form-control, .form-control-sm, select.form-control, textarea.form-control {
        ...
        .form-control[readonly], textarea[readonly] { opacity: .95; background-color: #f8f9fa !important; }
