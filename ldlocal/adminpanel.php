...
<div class="col-md-12">
<table id="report_data" name="report_data" class="table  table-striped table-responsive table-condensed text-center borderless"></table>
<!-- <input type="text" name="searchxx" id="searchxx"> -->
...
<input type="text" class="form form-control" name="alu" id="alu" placeholder="ALU" >
</div>

<div class="form-group col-4 col-md-4 col-lg-4 divnewalu" style ="display:none">
<label id="newalulbl">ALU</label>
<input type="text" class="form form-control" name="newalu" id="newalu" placeholder="ALU" >
</div>
...
<input type="text" class="form form-control" name="serialno" id="serialno" placeholder="SERIAL NO" >
</div>
...
$("#newstatus").change(function (e) { 
  ...
  if (Multitag != 'Y') {
    ...
    if (Status == "REPAIRED" || Status == "RETURN ITEM") {
      ...
      $('.divserial').attr('readonly', true);
      }
      else if (Status == "REPLACE SAME MODEL" && Multitag != 'Y') {
      $('.divhide').css({'display':'block'});
      ...
      else if (Status == "REPLACE DIFFERENT MODEL" && Multitag != 'Y') {
