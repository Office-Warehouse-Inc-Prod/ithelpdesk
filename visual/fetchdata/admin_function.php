...
class dbconfig extends dbconn
{
	...
	public function overallpie_res(){
		...
		$query="
			...
			where `reports`.`sub_id` NOT IN ('15','28','34','35') AND `status` NOT IN ('WAITING FOR IT HELPDESK RESPONSE','NEW REPORT') AND YEAR(date_created) IN (".$_POST['yr'] .") AND reports.deptsel = '6'
			GROUP BY `status`
...
// fix update cj for tech datatable
	...
	public function pie(){
		...
		FROM vwp 
		WHERE deptsel = '6' AND date_created IN (".$_POST['yr'] .")
