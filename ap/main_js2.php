...
$(document).on("submit", "#report_form", function (e) {
  ...
  // Keep the date validation logic
  ...
  // --- REMOVED THE "All Fields are Required" IF/ELSE BLOCK ---
  // Form submission proceeds directly from here

  var disabledFields = $('#store, #via, #status, #itsup, #cat, #sub');
  disabledFields.prop('disabled', false); // Temporarily enable fields so FormData catches them
