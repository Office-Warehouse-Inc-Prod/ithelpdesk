  ...
  function admin_datatable(t){
    ...
    $('#fix_asset_table tbody').off('click', 'button[name="update"]').on('click', 'button[name="update"]', function (e) {
     ...
     if (isTechnical === 1) {
          ...
          $('#problem_reported, #verification_findings, #work_done, #status_workoutput, #recommendation').prop('required', true);
          ...
          $('#problem_reported, #verification_findings, #work_done, #status_workoutput, #recommendation').prop('required', false);
