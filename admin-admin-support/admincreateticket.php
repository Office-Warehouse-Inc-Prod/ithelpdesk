        ...
        <form method="post" id="create_report_form" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <select class="modern-input" id="subject" name="subject" required>
                <option value="" selected disabled>---Select Category---</option>
              </select>
            </div>

            <div class="form-group col-md-6 mb-3" id="subcategory_container" style="display: none;">
              <label><i class="fas fa-tag mr-1"></i> Subcategory</label>
              <select class="modern-input" id="subcategory" name="sub">
            ...
            <div class="form-group col-12 mb-3">
              ...
              <textarea class="modern-input" id="concern" name="concern" minlength="10" maxlength="1000" placeholder="Describe the concern or request in detail..." required></textarea>
            </div>

            <div class="form-group col-12 mb-4">
              <label><i class="fas fa-paperclip mr-1"></i> Attach Files (Optional)</label>
              <!-- Fixed ID to match JS -->
              <input id="create_file-input" type="file" name="files[]" multiple class="form-control-file d-block mb-1">
          ...
          <div class="d-flex align-items-center justify-content-between pt-3 border-top">
            ...
            <div class="d-flex gap-2">
              ...
              <button type="submit" name="action" id="action" class="btn text-white px-4 font-weight-bold" style="border-radius: 8px; background: #213456;">
          ...
          <div class="modal-body">
            ...
            <div class="m_col col-12 col-lg-6">
                <div class="row">
                  ...
                  <input type="hidden" name="is_fix_asset" id="modal_is_fix_asset" value="0">
                  ...
                  <div class="col-12">
                    ...
                    <!-- Array bracket fix applied here -->
                    <p><input id="file-input" type="file" name="files[]" multiple></p>
                  </div>
                 ...
                 <div class="card mt-3 p-3">
                    <h6 style="color: #213456; font-weight: bold;">Attached Files:</h6>
                    <div id="img"></div>
                 </div>
...
$(document).ready(function() {
    $('#subject').on('change', function() {
        let selectedCategory = $(this).find('option:selected').text().toUpperCase();
        
        if (selectedCategory.includes('FIXED ASSET') || selectedCategory.includes('FIX ASSET')) {
            $('#is_fix_asset').val('1');
            $('#inline_fixed_asset_fields').slideDown();
            $('#inline_fa_description_sel').attr('required', true);
        } else {
            $('#is_fix_asset').val('0'); 
            $('#inline_fixed_asset_fields').slideUp();
            $('#inline_fa_description_sel').removeAttr('required');
        }
    });
    
    $('#inline_fa_description_sel').on('change', function() {
        if ($(this).val() === 'OTHER') {
            $('#inline_fa_description_txt').slideDown().attr('required', true);
        } else {
            $('#inline_fa_description_txt').slideUp().removeAttr('required');
        }
    });
});
</script>