...
<!-- <form> -->
  ...
  <div class="row">
    ...
    <div class="form-group col-md-4">
      <label>VIA</label>
  <input type="text" class="form form-control" name="via" id="via" value="SERVICE REQUEST" readonly>
  </div>
      ...
      <label>ASSIGNED SUPPORT</label>
          ...
          <select class="form-control form-control-sm" name="itsup" id="itsup" required>
             <option value="">Assign support...</option>  
                   <?php
                            $query="select * from it_tech WHERE itsup NOT IN ('3','4','7','8','12') AND deptsel = '6'";
