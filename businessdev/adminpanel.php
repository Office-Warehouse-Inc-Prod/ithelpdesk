...
<div id="welcomeModal" class="modal-overlay" style="display: none;">
    <div class="modal-content">
        <h3>Business Development HelpDesk Efficiency & Performance Report</h3>
        ...
        <main class="p-4">
          <div class="row g-4">
            ...
            <div class="row" id="ovrall">
              ...
              <div class="col-12 col-lg-6 mb-3">
                <div class="card card2 h-100">
                  <h5 class="card-header text-black" style="background-color: #95a2b9b4; color:black;">Business Support Logs
                  </h5>
                  <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-12 col-md-8">
                    ...
                    <select class="form-control form-control-sm" name="itsup" id="itsup" required>
                      ...
                      <?php
                      $query = "select * from it_tech WHERE deptsel = '18' AND itsup NOT IN ('4','8','12','14')";
                      $run = $conn->prepare($query);
                      $run->execute();
                      $rs = $run->get_result();
                      while ($res = $rs->fetch_assoc()) {
                  ...
                  <div class="form-group col-12 col-md-4">
                    ...
                    <select class="form-control form-control-sm" name="cat" id="cat" required>
                      ...
                      $query = "select * from categories WHERE deptsel = '18' AND old_tag IS NULL";
                      $run = $conn->prepare($query);
                      $run->execute();
                      $rs = $run->get_result();
                      while ($res = $rs->fetch_assoc()) {
                  ...
                  <div class="form-group col-12 col-md-4">
                    ...
                    <select class="form-control form-control-sm" name="status" id="status" required>
                      ...
                      <?php
                      $query = "select * from status  WHERE bussinessdev_module_tag = 'Y1'";
                      $run = $conn->prepare($query);
                      $run->execute();
                      $rs = $run->get_result();
                      while ($res = $rs->fetch_assoc()) {
