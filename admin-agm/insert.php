    ...
    try {
       ...
       $result = $statement->execute([
        ...
        $result2 = $statement2->execute([
            ...
            ':notif_data' => "Fixed asset " . $ticketNo . " has been already approved by Ma'am Althea Bunachita",
            ':notif_val'  => '9',
...
if (isset($_POST["operation"]) && $_POST["operation"] === "add_remarks_only") {
    ...
    try {
        ...
        $resultNotif = $statementNotif->execute([
            ...
            ':store'      => $_SESSION["str_num"] ?? "",
            ':itsup'      => $_SESSION["tech_id"] ?? "",
            ':notif_data' => "AGM - Althea Bunachita added a remarks on fixed asset ticket no " . $ticketNo,
            ':notif_val'  => '10',
            ':notif_date' => $currentDate
        ]);
