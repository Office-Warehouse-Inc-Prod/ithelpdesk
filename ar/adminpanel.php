    ...
    <div class="main-container">  
      <main class="p-4">
        ...
        <div class="row" id="ovrall">
          ...
          <div class="col-12 col-lg-6 mb-3">
            <div class="card card2 h-100">
              <h5 class="card-header text-black"  style="background-color: #95a2b9b4; color:black;">Account Recievable Support Logs</h5>
              <div class="card-body">
            ...
            <div class="m_col col-12 col-lg-6">
              ...
              <div class="row">
                ...
                <div class="form-group col-12 col-md-8">
                  <label>ACCOUNT RECEIVABLE SUPPORT</label>
                  ...
                  <select class="form-control form-control-sm" name="itsup" id="itsup" required>
                    ...
                    <?php
                      $query="select * from it_tech WHERE deptsel = '16' AND itsup NOT IN ('4','7','8','12','14')";
                      $run=$conn->prepare($query);
                      $run->execute();
                      $rs=$run->get_result();
                      while ($res=$rs->fetch_assoc()) {
                  ...
                  <select class="form-control form-control-sm" name="cat" id="cat" required>
                    ...
                    <?php
                      // $query="select * from category WHERE deptsel = '1'";
                          $query="select * from categories WHERE deptsel = '16'";
                      $run=$conn->prepare($query);
                      $run->execute();
                      $rs=$run->get_result();
                      while ($res=$rs->fetch_assoc()) {
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '#navCreateReport', function (e) {
      ...
      if (window.location.pathname.endsWith('adminpanel.php') || window.location.pathname.endsWith('/ar/')) {
        e.preventDefault();
