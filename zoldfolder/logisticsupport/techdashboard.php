...
<div class="dashcard card text-white mb-4 bg-primary border-dark hide2" style="width: 20rem; height: 9rem;">
<div class="card-body">
...
<div class="dashcard card text-white mb-4 bg-danger hide2" style="width: 20rem; height: 9rem; ">
<div class="card-body">
...
<div class="dashcard card text-white mb-4 bg-secondary hide2" style="width: 18rem; height: 9rem; ">
<div class="card-body">
...
<div class="dashcard card text-white mb-4 bg-info hide2" style="width: 18rem; height: 9rem; ">
<div class="card-body">
...
<div class="dashcard card text-white mb-4 bg-warning hide2" style="width: 18rem; height: 9rem; ">
<div class="card-body">
...
<div class="dashcard card text-white mb-4 bg-primary hide1" style="width: 18rem; height: 9rem; ">
<div class="card-body">
...
<div class="dashcard card text-white mb-4 bg-success hide1" style="width: 18rem; height: 9rem; ">
<div class="card-body">
...
<div class="dashcard card text-white mb-4 bg-success hide2" style="width: 20rem; height: 9rem;">
<div class="card-body">
...
<div class="form-group col-4 col-md-4 col-lg-4">
<label>STATUS</label>
<!-- <input type="text" class="form-control form-control-sm" name="status" id="status" value="OPEN"> -->
