...
$data=   array(
  ...
  $statement = $connection->prepare(
    ...
    SET ticket_no = :ticket_no, $brid date_created = :date_created,  via = :via, 
                     status = :status, $itsup $cat_id $sub_id $ispid refNo = :refNo, date_refNo = :date_refNo, tripticket1 = :tripticket1,  tripticket2 = :tripticket2, date_closed = :date_closed, $clby remarks = :remarks
